 ...
 */
class Search extends \DirectoryPlatform\AppBundle\Entity\Search implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\Search' . "\0" . 'user', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\Search' . "\0" . 'query', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\Search' . "\0" . 'entity', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\Search' . "\0" . 'created', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\Search' . "\0" . 'modified'];
        }
