 ...
 */
class Image extends \DirectoryPlatform\AppBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\Image' . "\0" . 'listing', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\Image' . "\0" . 'image', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\Image' . "\0" . 'imageName', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\Image' . "\0" . 'created', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\Image' . "\0" . 'modified'];
        }
