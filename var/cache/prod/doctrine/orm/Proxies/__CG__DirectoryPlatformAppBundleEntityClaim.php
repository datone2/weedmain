 ...
 */
class Claim extends \DirectoryPlatform\AppBundle\Entity\Claim implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\Claim' . "\0" . 'user', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\Claim' . "\0" . 'listing', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\Claim' . "\0" . 'message', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\Claim' . "\0" . 'isApproved', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\Claim' . "\0" . 'created', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\Claim' . "\0" . 'modified'];
        }
