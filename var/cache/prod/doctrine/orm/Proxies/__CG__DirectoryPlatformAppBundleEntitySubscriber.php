 ...
 */
class Subscriber extends \DirectoryPlatform\AppBundle\Entity\Subscriber implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\Subscriber' . "\0" . 'email', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\Subscriber' . "\0" . 'created', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\Subscriber' . "\0" . 'modified'];
        }
