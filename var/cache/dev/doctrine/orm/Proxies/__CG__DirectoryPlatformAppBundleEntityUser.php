 ...
 */
class User extends \DirectoryPlatform\AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\User' . "\0" . 'posts', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\User' . "\0" . 'listings', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\User' . "\0" . 'reviews', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\User' . "\0" . 'favorites', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\User' . "\0" . 'profile', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\User' . "\0" . 'isVerified', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\User' . "\0" . 'created', '' . "\0" . 'DirectoryPlatform\\AppBundle\\Entity\\User' . "\0" . 'modified', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
