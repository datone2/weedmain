...
{
/**
	 * @Route("/categories/export", name="admin_category_export")
	 */
	public function exportAction()
	{
	
		//$data = array("data" => "test");
		$data = $this->getDoctrine()->getRepository('AppBundle:Category')->findParent();
//$data = $this->get('knp_paginator')->paginate($categories,  1, 10);

		$format = 'csv'; 

		if ($format == "csv") {
			$response = $this->render('AdminBundle:Category:export.' . $format . '.twig', array('data' => $data));
