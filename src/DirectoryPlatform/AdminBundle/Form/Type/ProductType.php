...
use DirectoryPlatform\AdminBundle\Form\Type\ImageType;
...
/* ->add('user', EntityType::class, [
						...
						'required' => false,
						'choices' => $options['hierarchy_users']->tree(),
						'choice_label' => function($user) use ($options) {
							return $options['hierarchy_users']->getName($user);
						},
					]) */
		$builder
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
			'currency' => 'USD',
			'user' => null,
			'percentageThc'=>null,'percentageThca'=>null,'percentageCbd'=>null,'percentageCba'=>null,'percentageCbn'=>null,
